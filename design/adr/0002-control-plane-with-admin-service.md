...
This ADR solidifies the "separation of control-plane and admin-service responsibilities" into an architectural decision record and incorporates it into `design/adr/` for continuous tracking. This issue stems from the `design/DESIGN.md` §16 open issue and is still open.
